...
bb0:                                              ; preds = %entry
  ...
  %load1 = load i32, ptr %_tmp_2, align 4
  %lt = icmp slt i32 %load1, 0
  store i1 %lt, ptr %_tmp_3, align 1
  %load2 = load i32, ptr %_x_0, align 4
  store i32 %load2, ptr %_tmp_4, align 4
  %load3 = load i32, ptr %_tmp_4, align 4
  %gt = icmp sgt i32 %load3, 100
  store i1 %gt, ptr %_tmp_5, align 1
  br label %bb4

bb4:                                              ; preds = %bb0
  %load4 = load i1, ptr %_tmp_3, align 1
  switch i1 %load4, label %bb5 [
    i1 true, label %bb2
  ]

bb5:                                              ; preds = %bb4
  %load5 = load i1, ptr %_tmp_5, align 1
  switch i1 %load5, label %bb3 [
    i1 true, label %bb3
  ]
